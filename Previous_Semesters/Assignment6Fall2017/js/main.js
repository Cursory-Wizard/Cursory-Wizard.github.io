...
function resetForm() {
    ...
    document.getElementById("oneDate").innerHTML = "-";
    document.getElementById("twoDate").innerHTML = "-";
    document.getElementById("threeDate").innerHTML = "-";
    document.getElementById("dateVolume").innerHTML = "-";
...
function convertDate() {
    ...
    var dateOne = new Date(document.getElementById("testOneDate").value);
    var dateTwo = new Date(document.getElementById("testTwoDate").value);
    var dateThree = new Date(document.getElementById("testThreeDate").value);

    document.getElementById("oneDate").innerHTML = dateFormat(dateOne);
    document.getElementById("twoDate").innerHTML = dateFormat(dateTwo);
    document.getElementById("threeDate").innerHTML = dateFormat(dateThree);
    document.getElementById("dateVolume").innerHTML = dateFormat(new Date());
}

function dateFormat(passedDate) {
    return dayOfWeek[passedDate.getDay()] + ",  " + monthOfYear[passedDate.getMonth()] + "  " + passedDate.getDate() + ",  " + passedDate.getFullYear();
}